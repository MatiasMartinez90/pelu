...
| 5 | Shop independiente | Fases 3–4 | Repo `ecommerce`, subdominio, build/pod propios, catálogo, detalle, búsqueda, carrito, checkout, retiro, stock y pedidos administrables | En progreso | Repo `ecommerce` PRs #1–#4 y GitOps #17–#22: storefront/build/pod propios, checkout y pago E2E verdes en dev. Falta mover catálogo, stock, pedidos y admin fuera de las tablas/API de Pelu. Ver `docu/fase-5-shop.md` y `docu/arquitectura-ecommerce-mercadopago.md` |
