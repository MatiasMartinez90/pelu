...
| 3 | Cloudflare y medios | Fase 4 parcial para tenancy; puede prototiparse antes | Medios publicados por tenant, formatos responsive, caché y fallback probados | En progreso | Contrato, manifiesto, pipeline, medios locales versionados y headers de caché del origen listos; R2 queda opcional porque requiere billing. Falta activar Cache Rule del dominio proxied y validar HIT/MISS. |
...
| 9 | Abandonos y automatizaciones | Fases 5, 7, 8 y consentimiento | Detección durable, cadencias, quiet hours, opt-out, límites y métricas por canal | En progreso | Ecommerce PR #9 marca carritos inactivos atómicamente y expone cola segura de recuperación; falta scheduler/canales tras consentimiento y proveedores. |
| 10 | Admin unificado | Fases 7–8 | “Agente y conversaciones”, bandeja multicanal, filtros, estados, handoff, cliente y métricas | Listo en dev | Pelu PR #73/#74: canales visibles y workspace único “Agente y conversaciones” con métricas + bandeja. |
| 11 | Campañas | Fases 7–10 | Editor/programación/segmentos/consentimiento/cancelación/auditoría/resultados | En progreso | Pelu PR #75: consentimientos, suppression list, campañas draft/aprobación y deliveries idempotentes; falta UI completa y proveedores. |
| 12 | Productos Sir Fausto | Fases 4–5 | Cinco productos demo con datos editables, stock, precio, SKU, SEO y medios autorizados | Listo en dev | Ecommerce PR #10: cinco medios SVG demo locales y livianos; reemplazo por packshots autorizados queda manual. |
| 13 | Videos con IA | Fases 3 y 12 | Variantes mobile/desktop, CDN, reduced-motion y claims seguros | En progreso | Ecommerce PR #11: `video_url` opcional, controles, `muted`, `playsInline`, `preload=metadata` y fallback; faltan videos aprobados. |
