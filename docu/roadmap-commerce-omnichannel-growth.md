...
| 5 | Shop independiente | Fases 3–4 | Subdominio propio, catálogo, detalle, búsqueda, carrito, checkout, retiro, stock y pedidos administrables | En curso | Core PR #40 y storefront PR #41 desplegados/verificados en dev; operación admin en `feat/shop-admin-operations`. Ver `docu/fase-5-shop.md` |
