...
| 5 | Shop independiente | Fases 3–4 | Subdominio propio, catálogo, detalle, búsqueda, carrito, checkout, retiro, stock y pedidos administrables | En curso | Core en PR #40; experiencia standalone en `feat/shop-standalone-experience`; admin operativo y validación dev pendientes. Ver `docu/fase-5-shop.md` |
