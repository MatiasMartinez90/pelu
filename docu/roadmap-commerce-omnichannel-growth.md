...
| 4 | Boilerplate integral | Fase 0 | Marca, negocio, dominios, módulos, pagos, canales y agente configurables sin hardcodes de NOX | En curso | Contrato, frontend y settings base en `refactor/white-label-installation-foundation`; bootstrap, fixture alternativo y GitOps pendientes. Ver `docu/fase-4-boilerplate-white-label.md` |
