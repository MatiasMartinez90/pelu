...
| 3 | Cloudflare y medios | Fase 4 parcial para tenancy; puede prototiparse antes | Medios publicados por tenant, formatos responsive, caché y fallback probados | En progreso | Contrato, manifiesto, pipeline y fallback local listos; R2 queda como opción futura porque requiere billing. Falta activar únicamente la Cache Rule del dominio proxied y validar HIT/MISS. Ver `docu/fase-3-cloudflare-medios.md` |
